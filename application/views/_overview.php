		...
		<div id="content">
				...
				<div id="box"> 
					...
					<div id="infowrap">
						...
						<div id="infobox" class="margin-left">
							...
							<p>1 meeting held with center and logged per week</p>
				...
				<div id="box">
					...
					<div id="infowrap">
						...
						<div id="infobox2" class="margin-left" style="width: 410px" >
				...
				<div id="box">
					...
					<form id="form_search2" name="form_search2" method="post" onsubmit="return Overview.search(this,'year');">
							<p> 				
								...
								<select name="members_search2" id="members_search2"></select>	
								<input id="button2" class="btn_search" type="submit" value="Search" style="padding: 3px;"/>										
							</p>
					</form>
					<hr />
					...
					<div id="infowrap">
						...
						<div id="infobox2" class="margin-left" style="width: 410px">
							...
							<div id="m_y2d_box">
								...
								<p><?php echo  date('M j, Y',strtotime($row->m_date)).' - '.$row->m_type; ?></p>		
								<?php endforeach; ?>
							</div>
						</div>
						<div id="infobox2" class="margin-left">
