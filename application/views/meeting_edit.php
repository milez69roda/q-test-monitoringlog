...
$(document).ready(function() {
	...
	$("#m_dateadded").datetimepicker({ "dateFormat": 'yy-mm-dd',
				...
				<div id="rightnow" >
					...
					<form id="form" action="" method="post" onSubmit="return Meeting.submit(this);">	
							...
							<p>
								...
								<!--<input type="text" name="weekending" id="weekending" value="<?php //echo date("D M j Y", strtotime($row->m_weekending)); ?>" readonly="readonly"/>-->
								
								<?php   
									if( $this->user_access == 1 OR $this->config->item('meeting_extension') ){ 
							...
							<?php if( $this->config->item('meeting_extension') ): ?>	
							<p>
								<label for="m_dateadded">Date Added : </label> 
								<input name="m_dateadded" id="m_dateadded" type="text" tabindex="1" value="<?php echo $row->m_dateadded ?>" /> <em>Note: please also change the date added if you change the weekending</em>
							</p>
							<?php endif; ?>			
							<p>
