				...
				<div id="rightnow">
					...
					<form id="form" name="form1" action="" method="post" onSubmit="return Calls.submit(this);">	
							...
							<p>
								...
								<?php   
									if( $this->user_access == 1 OR $this->config->item('calls_extension')){ 
							...
							<p>
								...
								<?php //echo form_dropdown('calltype', $calltype, $row->call_type, 'id="calltype" onChange="Calls.subcalltype(this,\'\' )"'); ?> 
							</p>
								<script>
								$(function(){
									//Calls.subcalltype("#calltype", '<?php echo $row->call_subtype ?>');
								});
							</script>	
							<p>
